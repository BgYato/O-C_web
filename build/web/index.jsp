      ...
      <div class="header_main">
         <div class="mobile_menu">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo_mobile"><a href="index.html"><img src="public/images/logo.png"></a></div>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link " href="blog.html">Registrarme</a>
                     </li>
                     <li class="nav-item">
         ...
         <div class="container-fluid">
            ...
            <div class="menu_main">
               <ul>
                  ...
                  <li><a href="usuario?navegacion=login">Iniciar sesión</a></li>
                  <li><a href="usuario?navegacion=register">Registrarme</a></li>
   ...
   <div class="services_section layout_padding">
      <div class="container">
         ...
         <div class="services_section_2">
            <div class="row">
               <div class="col-md-4">
                  <div><img src="public/images/img-1.png" class="services_img"></div>
                  <div class="btn_main"><a href="#">Rafting</a></div>
               </div>
               <div class="col-md-4">
                  <div><img src="public/images/img-2.png" class="services_img"></div>
                  <div class="btn_main active"><a href="#">Hiking</a></div>
               </div>
               <div class="col-md-4">
                  <div><img src="public/images/img-3.png" class="services_img"></div>
      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-6 padding_right_0">
               <div><img src="public/images/about-img.png" class="about_img"></div>
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="blog_section layout_padding">
      <div class="container">
         ...
         <div class="play_icon_main">
            <div class="play_icon"><a href="#"><img src="public/images/play-icon.png"></a></div>
         </div>
      </div>
   </div>
   <!-- blog section end -->
                     ...
                     <div class="client_main">
                        ...
                        <div class="box_right">
                           <div class="client_taital_left">
                              <div class="client_img"><img src="public/images/client-img.png"></div>
                              <div class="quick_icon"><img src="public/images/quick-icon.png"></div>
                           </div>
   ...
   <div class="footer_section layout_padding">
      <div class="container">
         ...
         <div class="location_main">
            <div class="call_text"><img src="public/images/call-icon.png"></div>
            <div class="call_text"><a href="#">Call +01 1234567890</a></div>
            <div class="call_text"><img src="public/images/mail-icon.png"></div>
