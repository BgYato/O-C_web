                    ...
                    <div class="row g-0">
                      ...
                      <div class="col-xl-6">
                        <div class="card-body p-md-5 text-black">
                          <h3 class="mb-5 text-uppercase">Datos personales</h3>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                  <input type="text" id="apellido" class="form-control form-control-lg" name="apellido" required/>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                  <input type="number" id="doc" class="form-control form-control-lg" name="doc" required/>
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">                                
                                <input type="number" id="celular" class="form-control form-control-lg" name="celular" required/>
                                <label class="form-label" for="celular">Número de celular</label>
                              </div>
                            </div>
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                  <input type="number" id="fijo" class="form-control form-control-lg" name="fijo" required/>
                          ...
                          <div class="form-outline mb-4">
                            <input type="text" id="fechaNac" class="form-control form-control-lg" name="fechaNac" required placeholder="YYYY-mm-DD"/>
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">                                
                                <input type="text" id="municipio" class="form-control form-control-lg" name="municipio" required/>
                                <label class="form-label" for="municipio">Municipio</label>
                              </div>
                            </div>
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                  <input type="text" id="barrio" class="form-control form-control-lg" name="barrio" required/>
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">                                
                                <input type="text" id="etnia" class="form-control form-control-lg" name="etnia" required/>
                                <label class="form-label" for="etnia">Etnia</label>
                              </div>
                            </div>
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                  <input type="text" id="etnia" class="form-control form-control-lg" name="condicion" required/>
                          ...
                          <div class="form-outline mb-4">
                              <input type="number" id="estrato" class="form-control form-control-lg" name="estrato" required/>
                            <label class="form-label" for="estrato">Estrato </label>
                          </div>  

                          <div class="d-flex justify-content-end pt-3">                            
                            <input type="submit" class="btn btn-warning btn-lg ms-2" value="Registrarme"/>
                          </div>
